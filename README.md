...
The selected profile must still pass the original company, role, seniority,
location, email, and source checks. Unselected options do not cause automatic
searches during final submission.
