...
def build_prompt(icp: dict[str, Any], max_companies: int | None = None) -> str:
    ...
    if contact_guidance and os.environ.get("LAB_ARENA_WORKER_SOCKET", "").strip():
        contact_guidance += (
            ...
            "Once a candidate's name, website, LinkedIn company URL, and basic fit are established, "
            "put get_company_contact before any other tool in the same batch and before researching "
            "another candidate. "
